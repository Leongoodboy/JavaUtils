...
public class ExcelXLSInputer extends FileInputer {
	...
	public ExcelXLSInputer(InputStream inputStream) {
		super(inputStream);
	}

	public ExcelXLSInputer(String path) throws FileNotFoundException {
		super(path);
	}
	...
	public void initialize() throws Exception {
		...
		// if (sheetIndex == null && sheetName != null) {
